                            ...
                            <div >
                                <div >
                                     <ol class="breadcrumb text-left">
                                        ...
                                        <li class="active">
                                              <a href="#"><i class="glyphicon glyphicon-cog"></i> Nueva Mensualidad</a>
                                        </li>                                      
                                    </ol>
                                </div>
                            </div>
                ...
                <div class="panel-body">
                 <form class="form-horizontal" role="form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input  type="number" min="0" step="1" class="form-control" id="txt_monto" placeholder="Monto de la Mensualidad por Cobrar o Pagar">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="btn btn-primary" id="insert_Mensualidad">GUARDAR</button>
                    </div>
                  </div>
                </form>
              </div>
